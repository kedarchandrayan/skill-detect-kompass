...
//
// (async () => {
//   const resp = await spreadsheetHelper.createSpreadSheetAndGetUrl('Master', ['API', 'Request', 'Response Status', 'CSRF/Major', 'Vector']);
//   const spreadsheetId = resp.spreadsheetId;
//   const sheetId = resp.sheetId; // Assuming you have a sheet ID in your response
//
//   await spreadsheetHelper.appendRows(spreadsheetId, 'abc', [['1', '2', '3'], ['4', '5', '6']]);
// })();
