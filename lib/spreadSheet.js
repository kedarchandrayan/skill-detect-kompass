...
const credentials = require(rootPrefix + '/credential.json');
const auth = new google.auth.GoogleAuth({
  keyFile: `${rootPrefix}` + '/credential.json', // JSON file path
...
// Usage
//  a = require('./spreadsheet/spreadSheet/CreateSpreadSheet.js');
